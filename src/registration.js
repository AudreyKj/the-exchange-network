    ...
    submitClick(e) {
        ...
        axios
            ...
            .catch(function(error) {
                console.log("error in submit click for regsitration", error);
        ...
        return (
            <div className="register">
                ...
                {this.state.error_first && (
                    <span className="error-register">
                        Oops, something went wrong! please make sure you entered
                        your first name correctly.
                    </span>
                )}

                {this.state.error_last && (
                    <span className="error-register">
                        Oops, something went wrong! please make you entered your
                        last name correctly.
                    </span>
                )}
                ...
                {this.state.error_password && (
                    <span className="error-register">
                        Oops, something went wrong! please make your password
