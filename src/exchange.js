        ...
        <div className="exchange-wrapper">
            <div className="exchange">
                ...
                <form className="form-exchange">
                    EXCHANGE SERVICES, LANGUAGES, OR SKILLS WITH YOUR FRIENDS!
                    <span className="exchange-spec">
                        *THE EXCHANGES POSTS ARE ONLY VISIBLE TO USERS WHO ARE
                        FRIENDS
                    </span>
                    <br />
                    <label className="exchange" htmlFor="title">
                        ...
                        <span className="options">
                            --- language, skills, services, or other ---
                        </span>
                    </label>
                    <input
